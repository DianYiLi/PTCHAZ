...
% 
% nccreate(ff_pre,'lat','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'lat',blat1);
% ncwriteatt(ff_pre,'lat','long_name','latitude')
% nccreate(ff_pre,'dlat','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'dlat',dlat);
% ncwriteatt(ff_pre,'dlat','long_name','12 h lat change')
% 
% nccreate(ff_pre,'p0','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'p0',pres1);
% ncwriteatt(ff_pre,'p0','long_name','storm central pressure')
% nccreate(ff_pre,'dp0','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'dp0',dpres);
% ncwriteatt(ff_pre,'dp0','long_name','12 h p0 change')
% 
% nccreate(ff_pre,'mw','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'mw',wind1);
% ncwriteatt(ff_pre,'mw','long_name','maximum wind speed at 10 m height')
% nccreate(ff_pre,'dmw','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'dmw',dwind);
% ncwriteatt(ff_pre,'dmw','long_name','12 h mw change')
% 
% nccreate(ff_pre,'pi','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'pi',pi1);
% ncwriteatt(ff_pre,'pi','long_name','potential intensity')
% nccreate(ff_pre,'dpi','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'dpi',dpi);
% ncwriteatt(ff_pre,'dpi','long_name','12 h pi change')
% 
% nccreate(ff_pre,'shr','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'shr',shr1);
% ncwriteatt(ff_pre,'shr','long_name','vertical wind shear')
% nccreate(ff_pre,'dshr','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'dshr',dshr);
% ncwriteatt(ff_pre,'dshr','long_name','12 h shr change')
% 
% nccreate(ff_pre,'ts','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'ts',ts);
% ncwriteatt(ff_pre,'ts','long_name','translation speed')
% nccreate(ff_pre,'dts','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'dts',dts1);
% ncwriteatt(ff_pre,'dts','long_name','12 h ts change')
% 
% nccreate(ff_pre,'ex','Dimensions',{"valid data length",length(dts1)})
% ncwrite(ff_pre,'ex',et);
% ncwriteatt(ff_pre,'ex','long_name','if extratropical')